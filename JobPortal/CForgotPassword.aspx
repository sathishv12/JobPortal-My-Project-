<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="CForgotPassword.aspx.cs" Inherits="JobPortal.WebForm22" %>
    ...
    <tr>
        ...
        <td style="padding: 95px 200px 95px 200px; font-family: 'Microsoft Sans Serif'; font-size: 45px; font-weight: normal; font-style: normal; font-variant: normal; text-transform: none; background-color: #00CCFF; vertical-align: middle; text-align: left; line-height: 65px; color: #003366; ">
            <table border="1" width="100%" style="font-family: 'Microsoft Sans Serif'">
                ...
                <tr>
                    <td>
                        <asp:Button ID="Button1" runat="server" Text="Save" Font-Bold="True" Font-Names="Microsoft Sans Serif" Font-Size="XX-Large" Width="250px" BackColor="#00CCFF" BorderColor="#003366" BorderStyle="Outset" ForeColor="#003366" Height="55px" BorderWidth="2px" />
                    </td>
                    <td>
