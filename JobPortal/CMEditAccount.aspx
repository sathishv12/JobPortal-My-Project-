<%@ Page Title="" Language="C#" MasterPageFile="~/CompaniesMaster.Master" AutoEventWireup="true" CodeBehind="CMEditAccount.aspx.cs" Inherits="JobPortal.WebForm14" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td colspan="2">
            <center>EDIT<b> ACCOUNT</b></center>
        </td>
    </tr>
    <tr>
        <td>
