<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="JLogin.aspx.cs" Inherits="JobPortal.WebForm1" %>
    ...
    <table border="1" width="100%">
        ...
        <tr>
            <td width="40%" style="padding: 95px 75px 95px 70px; font-family: 'Microsoft Sans Serif'; font-size: xx-large; font-weight: normal; font-style: normal; font-variant: normal; text-transform: none; color: #003366; text-align: center; background-color: #F5F5F5;"><br />
                ...
                <asp:Label ID="Label2" runat="server" Text="Your Dream Job is Waiting For You"></asp:Label>
            </td>
                ...
                <table border="1" width="100%" style="font-family: 'Microsoft Sans Serif'">
                    ...
                    <tr>
                        <td>
                            ...
                            &nbsp; </td>
                        <td>
                            <asp:TextBox ID="TextBox1" runat="server" Height="45px" Width="300px" Font-Names="Microsoft Sans Serif" Font-Size="X-Large" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                 ...
                 <tr>
                    ...
                    <tr>
                        <td colspan="2" style="font-family: 'Microsoft Sans Serif'; font-size: large; text-align: right; line-height: 30px;" rowspan="1">
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/JRegister.aspx">Create account ?</asp:HyperLink>
                        </td>
                    </tr>
                    <tr>
