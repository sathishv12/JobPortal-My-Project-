<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="JForgotPassword.aspx.cs" Inherits="JobPortal.WebForm18" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td width="40%" style="padding: 95px 75px 95px 70px; font-family: 'Microsoft Sans Serif'; font-size: xx-large; font-weight: normal; font-style: normal; font-variant: normal; text-transform: none; color: #003366; text-align: center; background-color: #F5F5F5;"><br />
            <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Logo.png" Height="225px" Width="225px" /><br />
            <asp:Label ID="Label1" runat="server" Text="Welcome back!"></asp:Label><br />
            <asp:Label ID="Label2" runat="server" Text="The Easiest Way to Get Your Employee"></asp:Label>
        </td>
            ...
            <table border="1" width="100%" style="font-family: 'Microsoft Sans Serif'">
                ...
                <tr>
                    <td>
                        ...
                        &nbsp; </td>
                    <td>
                        <asp:DropDownList ID="DropDownList1" runat="server" Height="50px" Width="300px"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="Button1" runat="server" Text="Save" Font-Bold="True" Font-Names="Microsoft Sans Serif" Font-Size="XX-Large" Width="250px" BackColor="#00CCFF" BorderColor="#003366" BorderStyle="Outset" ForeColor="#003366" Height="55px" BorderWidth="2px" OnClick="Button1_Click" />
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="2" style="font-family: 'Microsoft Sans Serif'; font-size: large; text-align: right; line-height: 30px;" rowspan="1">
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/CRegister.aspx">Create account ?</asp:HyperLink>
                    </td>
                </tr>
                <tr>
