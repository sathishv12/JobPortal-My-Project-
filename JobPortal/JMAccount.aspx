<%@ Page Title="" Language="C#" MasterPageFile="~/JobsMaster.Master" AutoEventWireup="true" CodeBehind="JMAccount.aspx.cs" Inherits="JobPortal.WebForm9" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    zzzxZZXzzx<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1<table border="1" width="100%" style="padding: 40px 200px 40px 200px; margin: 0px; font-family: Verdana; font-size: xx-large; font-weight: normal; font-style: normal; font-variant: normal; text-transform: none; color: #800000; line-height: 60px; text-align: right; background-color: #FFFFCC; vertical-align: middle;">
     <tr>
         <td colspan="2">
     ...
     <tr>
        ...
        <td>
            ...
            <asp:DropDownList ID="DropDownList4" runat="server" Font-Names="Microsoft Sans Serif" Font-Size="Large" ForeColor="#003366" Height="45px" Width="275px" OnSelectedIndexChanged="DropDownList4_SelectedIndexChanged">
